...
public class AttributeBindingsAddapter {
    ...
    public static void setList(RecyclerView rv, ObservableList dataItems, RecyclerView.LayoutManager layoutManager, RecyclerView.ItemAnimator itemAnimator) {
        ...
        if (rv.getAdapter() == null) {
            String recyclerClass = new RecyclerViewBindingAdapter.AdapterDataItem(0, 0, new Object()).getClass().toString();
            ...
            if (recyclerClass.equals(currentDataItemClass)) {
                ...
                rv.setAdapter(new ProcessingOrdersRecyclerViewAdapter(dataItems));
            }
        }
